...
public class AppliactionServices {
    ...
    static List<String> parselist(List<String> list){
        ...
        for (String expression:list
            ...
            //String string1 = expression.substring(0,expression.charAt(expression.indexOf(":")));
            //expression = string1.strip() + expression.substring(expression.charAt(expression.indexOf(":")));
