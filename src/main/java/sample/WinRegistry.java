...
public class WinRegistry {
     ...
     */
        ...
        /*public boolean addValue(WRKey hkey, String key, String valueName, byte[] data,  WRType type) throws IOException, InterruptedException {
            String regString = createRegString(key,valueName,data,type,true);
        ...
        /*
        public boolean showValue(String key, String valueName)  throws IOException, InterruptedException{
            String regString = createRegString(key,valueName,null,null,true);
...
*/
        ...
        /*public static void main(String ... args) {
            ...
            try {
               ...
               if(! reg.showAllValues(WRKey.HKCU, "SOFTWARE\\Clients\\StartMenuInternet\\OperaStable\\Capabilities", "", true) ) {
